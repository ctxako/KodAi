...
// K2E: frozen copy of the schema as it existed before the workspace/chat
// split, used only by KodaiLocalStoreMigrationPlan (and tests) to open
// pre-split stores. In this version KodaiProject.sessions and
// KodaiChatSession.project / KodaiSummary.project were real SwiftData
// relationships; V2 replaces them with scalar projectID fields.
//
// Do not edit these classes: they must keep matching the on-disk schema of
// stores written before the split.
public enum KodaiLocalStoreSchemaV1: VersionedSchema {

...
//  kodai-consumer
//
//  Launch splash carried over from kodai-ios: the wolf mark rendered as a 3D
//  SceneKit point cloud, baked from the web piece (hero-wolf-3d.html →
//  wolf-points.json, in Resources/).
//
//  Static render, fitted to the screen, no user camera control. "Begin →"
        ...
        ZStack {
            ...
            VStack(spacing: 0) {
                ...
                VStack(spacing: 10) {
                    ...
                    Text("Set reminders, add events, save files — all on your\nphone. No cloud, no account, nothing leaves the device.")
                        .font(.footnote)
